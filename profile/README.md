...
- **[bomwiki](https://github.com/BOMWiki/bomwiki)** — the wiki engine (AGPL-3.0). Node.js and Postgres, no web framework, three runtime dependencies (`pg`, `marked`, `sanitize-html`). It runs bomwiki.com and you can run your own.
...
- **Improve the engine** — pull requests welcome on [BOMWiki/bomwiki](https://github.com/BOMWiki/bomwiki). Read [CONTRIBUTING](https://github.com/BOMWiki/bomwiki/blob/main/CONTRIBUTING.md) first; the dependency budget is real.
